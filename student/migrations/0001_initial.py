# Generated by Django 4.2.16 on 2024-09-26 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(blank=True, null=True)),
                ('C_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.course')),
                ('I_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.information')),
                ('S_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.student')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='favoite/')),
                ('title', models.CharField(blank=True, max_length=100, null=True)),
                ('F_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.favorite')),
            ],
        ),
        migrations.CreateModel(
            name='Like',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('S_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.student')),
                ('T_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.teacher')),
                ('W_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='student.work')),
            ],
        ),
        migrations.CreateModel(
            name='DiscussReply',
